<x-slot:header>Customer Management</x-slot:header>
<x-slot:subheader>Profile</x-slot:subheader>
<div class="pt-4">
    <div class="">
         @can(\App\Enums\Enum\PermissionEnum::CREATE_CUSTOMERS->value)               
        <section
                            ...
                            <tbody>
                                @foreach($items as $item)
                                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                                        ...
                                        <td class="px-6 py-4">
                                            @can(\App\Enums\Enum\PermissionEnum::EDIT_CUSTOMERS->value)  
                                            <x-button href="#" wire:click.prevent="edit({{ $item->id }})"
                                               variant="warning">Edit</x-button>
                                            @endcan
                                            @can(\App\Enums\Enum\PermissionEnum::DELETE_CUSTOMERS->value)  
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model="edit_address" id="edit_address"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500
                                        block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                                        dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter customer address" />
                    ...
                    <div class="relative w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-6 text-center">
                                ...
                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this customer profile?</h3>
