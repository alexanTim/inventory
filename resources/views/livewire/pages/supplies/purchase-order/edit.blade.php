        ...
        <x-collapsible-card title="Purchase Order Details" open="true" size="full">
            <form wire:submit.prevent="submit">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <x-input type="date" wire:model="loaded_date" name="loaded_date" label="Loaded Date" />
                    ...
                    <div x-data="{ show: @entangle('showModal') }" x-show="show" x-cloak class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full flex items-center justify-center">
                        <div class="relative w-full max-w-2xl max-h-full">
                            ...
                            <div class="relative">
                                ...
                                <x-input type="number" step="1" min="0" wire:model="expected_qty" name="expected_qty" label="Expected Quantity" placeholder="Enter expected quantity" />
                                    </div>
                                </div>
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <thead class="text-sm text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3">Expected Qty</th>
                            ...
                            <tbody>
                                @forelse($paginatedOrderedItems as $index => $item)
                                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4">{{ number_format($item['expected_qty'], 2) }}</td>
