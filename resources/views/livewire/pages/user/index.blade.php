...
<div class="">
    <div class="">
        @can(\App\Enums\Enum\PermissionEnum::CREATE_USER->value) 
                            ...
                            <tr
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex space-x-2">
                                        @can(\App\Enums\Enum\PermissionEnum::EDIT_USER->value) 
                                        <x-button type="button" wire:click="edit({{ $user->id }})"
                                            variant="warning" size="sm">Edit</x-button>
                                        @endcan

                                        @can(\App\Enums\Enum\PermissionEnum::DELETE_USER->value) 
