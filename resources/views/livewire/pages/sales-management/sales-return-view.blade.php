<div class="mb-14">
    ...
    a041aa73-e454-46e7-9f49-22c5cbb10946
    lass="ml-15 fixed bottom-0 right-0 p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 w-full">
        ...
        <div class="flex justify-end space-x-4">
            ...
            @endphp
            @can(PermissionEnum::APPROVE_SALES_RETURN->value) 
                <x-button 
                    type="button" 
