...
<div class="">
    <div class="">        
        @can(\App\Enums\Enum\PermissionEnum::CREATE_ALLOCATIONS->value)
                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-2">
                                    @can(\App\Enums\Enum\PermissionEnum::EDIT_ALLOCATIONS->value)
                                    <x-button type="button" wire:click="edit({{ $allocation->id }})" variant="warning" size="sm">Edit</x-button>
                                    @endcan
                                    @can(\App\Enums\Enum\PermissionEnum::DELETE_ALLOCATIONS->value)
