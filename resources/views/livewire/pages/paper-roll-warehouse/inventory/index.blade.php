                    ...
                    <div class="flex items-center justify-between p-4 pr-10">
                        <div class="flex space-x-6">
                            ...
                            <div class="flex items-center space-x-2">
                                <label class="text-sm font-medium text-zinc-900 dark:text-white">Material Type:</label>
                                <select
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model="{{ $model }}" id="{{ $model }}"
                                        class="bg-zinc-50 border border-zinc-300 text-zinc-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500
                                        block w-full p-2.5 dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-zinc-400 dark:text-white 
                                    ...
                                    @if(is_null($this->{$model}) || $this->{$model} === '')
                                        <span class="text-zinc-400 dark:text-zinc-500 text-xs mt-1">Currently: N/A</span>
                                    @endif
                                </div>
                                @endforeach
