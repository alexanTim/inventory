...
<div class="pt-4">
    <div class="">      
        @can(\App\Enums\Enum\PermissionEnum::CREATE_SUPPLIERS->value)
        <section
                            ...
                            <tbody>
                                @foreach($items as $item)
                                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                                        ...
                                        <td class="px-6 py-4">
                                            @can(\App\Enums\Enum\PermissionEnum::EDIT_SUPPLIERS->value)
                                            <x-button href="#" wire:click.prevent="edit({{ $item->id }})"
                                               variant="warning">Edit</x-button>
                                            @endcan
                                            @can(\App\Enums\Enum\PermissionEnum::DELETE_SUPPLIERS->value)
