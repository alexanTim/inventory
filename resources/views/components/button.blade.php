...
@php
    ...
    $variants = [
        'primary' => 'text-accent-foreground bg-accent hover:bg-accent-content focus:ring-accent/30',
        'secondary' => 'text-zinc-900 bg-white border border-zinc-300 hover:bg-zinc-100 focus:ring-zinc-200 dark:bg-zinc-800 dark:text-white dark:border-zinc-600 dark:hover:bg-zinc-700 dark:focus:ring-zinc-700',
