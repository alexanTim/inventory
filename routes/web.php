...
use App\Livewire\Pages\Requisition\RequestSlip\Create as RequestSlipCreate;
...
use App\Livewire\Pages\Supplies\PurchaseOrder\PurchaseOrderDeliveriesTable;

use App\Livewire\Pages\Supplies\PurchaseOrder\ViewDeliveryOrderitems;
...
use App\Livewire\Pages\Setup\ItemClass\Index as ItemClassSetup;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/RequestSlip/create', RequestSlipCreate::class)
        ->name('requisition.requestslip.create');
    ...
    Route::get('/Product/PurchaseOrder/ShowWithQr/{Id}', \App\Livewire\Pages\Supplies\PurchaseOrder\ShowWithQr::class)
        ->name('supplies.PurchaseOrder.showWithQr');

    Route::get('/Product/PurchaseOrder/Edit/{Id}', EditSuppliesPurchaseOrder::class)
        ->name('supplies.PurchaseOrder.edit');

    Route::get('/delivery-order', PurchaseOrderDeliveriesTable::class)
        ->name('supplies.DeliveryOrder');
        
    Route::get('/deliveryOrder/view/{Id}', ViewDeliveryOrderitems::class)
        ->name('supplies.DeliveryOrder.view');
    ...
    Route::get('/Setup/ItemClass', ItemClassSetup::class)
        ->name('setup.itemClass');
