...
class Edit extends Component
{
    ...
    public function mount($Id)
    {
        ...
        $this->loaded_date = $this->purchaseOrder->loaded_date ? $this->purchaseOrder->loaded_date->format('Y-m-d') : '';
        ...
        foreach ($this->purchaseOrder->supplyOrders as $order) {
            $this->orderedItems[] = [
                ...
                'expected_qty' => $order->expected_qty,
            ];
        }
    }
    ...
    public function editItem($index)
    {
        ...
        $this->expected_qty = $item['expected_qty'];
        $this->showModal = true;
    }
